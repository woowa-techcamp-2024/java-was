...
public class MultipartParserTest {
    ...
    public void testParseMultipartFormData() throws Exception {
        ...
        String rawRequest = "--boundary\r\n" +
                ...
                "--boundary--";
        BufferedInputStream inputStream = new BufferedInputStream(new ByteArrayInputStream(rawRequest.getBytes(StandardCharsets.ISO_8859_1)));
        HttpRequest request = new HttpRequest();
        request.setHeaders(Map.of("Content-Type", List.of("multipart/form-data; boundary=boundary")));

        // When
        MultipartParser.parse(inputStream, request);
        ...
        assertEquals("This is the content of the file.", new String(fileItem.getContent(), StandardCharsets.UTF_8));
    }
