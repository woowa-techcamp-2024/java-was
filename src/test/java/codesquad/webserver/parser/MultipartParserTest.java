...
public class MultipartParserTest {
    ...
    public void testParseMultipartFormData() throws Exception {
        ...
        Map<String, String> fields = request.getMultipartFields();
        Map<String, HttpRequest.FileItem> files = request.getMultipartFiles();
        ...
        HttpRequest.FileItem fileItem = files.get("file1");
