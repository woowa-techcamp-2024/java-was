...
public class HeaderParserTest {
    ...
    public void testParseHeaders() throws IOException {
        ...
        String headersString = "Content-Type: application/json\r\n" +
                ...
                "Host: localhost\r\n" +
                "\r\n";
        BufferedInputStream in = new BufferedInputStream(new ByteArrayInputStream(headersString.getBytes()));
        ...
        assertEquals(List.of("123"), headers.get("Content-Length"));
        assertEquals(List.of("localhost"), headers.get("Host"));
    }
