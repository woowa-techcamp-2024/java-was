...
public final class HttpResponseGenerator {
    ...
    public HttpResponse sendError(HttpRequest httpRequest, StatusCode statusCode, String message) {
        return generate(statusCode, message.getBytes(), MediaType.TEXT_HTML, httpRequest);
    }
